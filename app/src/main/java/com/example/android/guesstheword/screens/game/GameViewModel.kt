...
class GameViewModel : ViewModel() {
    ...
    //livedata B : emitting a string in the exact format we need
    ...
    init {
        ...
        //calling this functions each time the view-model gets created and not when the fragment gets created
        resetList()
        nextWord()

        //creates a timer which it triggers at the end of the game when it finishes
    ...
    override fun onCleared() {
        ...
        //to avoid memo leaks we need to cancel the  timer if we no longer need it
        timer.cancel()
